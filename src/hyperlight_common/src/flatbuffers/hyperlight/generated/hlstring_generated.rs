...
pub struct hlstring<'a> {
    pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for hlstring<'a> {
...
impl<'a> hlstring<'a> {
    ...
    pub fn value(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(hlstring::VT_VALUE, None)
        }
    }
}

impl flatbuffers::Verifiable for hlstring<'_> {
    #[inline]
    fn run_verifier(
...
pub struct hlstringArgs<'a> {
    pub value: Option<flatbuffers::WIPOffset<&'a str>>,
}
impl<'a> Default for hlstringArgs<'a> {
    #[inline]
    fn default() -> Self {
        hlstringArgs { value: None }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> hlstringBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn finish(self) -> flatbuffers::WIPOffset<hlstring<'a>> {
        let o = self.fbb_.end_table(self.start_);
        flatbuffers::WIPOffset::new(o.value())
    }
}

impl core::fmt::Debug for hlstring<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let mut ds = f.debug_struct("hlstring");
